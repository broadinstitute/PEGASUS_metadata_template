...
class TestAuthorConclusionSelection(unittest.TestCase):
    """The list selects positive matrix conclusions without duplicating them."""
    ...
    def test_list_does_not_need_author_conclusion_column(self) -> None:
